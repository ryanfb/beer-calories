...
(function() {
  var build_untappd_calories, calculate_calories, delete_cookie, expires_in_to_date, filter_url_params, get_cookie, parse_query_string, set_access_token_cookie, set_cookie, untappd_auth_url, untappd_config;
  ...
  build_untappd_calories = function(params) {
    if (get_cookie('access_token')) {
      ...
      return window.location = untappd_auth_url();
    }
  };
