...
(function() {
  var build_untappd_calories, calculate_calories, filter_url_params, parse_query_string, set_access_token, untappd_api_url, untappd_auth_url, untappd_config;
  ...
  build_untappd_calories = function(params) {
    $('#abv').change(function() {
      return $('#calories').text(calculate_calories($('#abv').val()));
    });
